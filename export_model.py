...
# python3 export_model.py --model_path ./model/base/ --task_type="mrc"
...
parser.add_argument("--task_type", type=str, required=True, default="mrc", choices=["ner", "cls", "mrc"], help="Select the task type.")
